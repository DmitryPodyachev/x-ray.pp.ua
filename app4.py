...
#image_path = "examples/mymom1.jpg"
#gr.HTML(f"""<img src="/file={image_path}" width="100" height="100">""")

#app.launch(server_name="0.0.0.0", server_port=7860, debug=True, allowed_paths=[image_path])
#path_to_image = "my_photo.jpg" 

#with gr.Blocks() as demo:
    # Просто передаем путь в аргумент value
...
with gr.Blocks() as demo:
    ...
    You can use this x-ray image as example:
...
#    demo.launch(share=False, debug=True, allowed_paths=["examples"])
